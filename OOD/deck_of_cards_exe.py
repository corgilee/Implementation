...
'''
Representation of Cards: Each card in the deck should be represented by its suit and rank. The deck should include all standard playing cards, 
which typically consist of four suits (hearts, diamonds, clubs, and spades) and thirteen ranks (2 through 10, Jack, Queen, King, and Ace).
